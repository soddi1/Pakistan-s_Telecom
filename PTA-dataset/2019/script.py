...
# Sample usage
pdf_path = 'qos_survey_3rd_4th_qtr_2019_19032020.pdf'  # Replace with your PDF file path
...
cities_list.append("Sibbi")
cities_list.append("TandoAllahYar")
cities_list.append("Taxila")
